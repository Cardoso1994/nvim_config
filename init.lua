...
-- Center cursor befor ctrl-u or ctrl-d
vim.keymap.set('n', '<C-d>', 'zz<C-d>', { desc = 'Scroll down and center' })
vim.keymap.set('n', '<C-u>', 'zz<C-u>', { desc = 'Scroll up and center' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- NOTE: Most keybindings moved to snacks.picker (lua/custom/plugins/snacks.lua)
      -- Telescope kept for ui-select and specialized pickers
  ...
  },
  {
    ...
    config = function()
      ...
      --[[ require('mason-lspconfig').setup {
        -- Instead of a custom handler, specify which servers you want to set up
        ensure_installed = vim.tbl_keys(servers or {}),
        -- You can keep the automatic_installation feature if you want
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Pairs of delimiters: brackets, parethesis, quotes, etc
